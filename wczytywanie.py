...
# Nowa funkcja, która zbiera wszystko w słownik (zamiast w mainie)
def load_all_data():
    """
    Zaleta: Nie tworzysz zmiennych df2015, df2018
    tylko jeden słownik 'all_years_data'.
    """
    all_years_data = {}

    # Przechodzimy pętlą po latach z Twojego słownika gios_url_ids
